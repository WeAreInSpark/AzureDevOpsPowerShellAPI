BeforeDiscovery {
  Get-Module "AzureDevOpsPowerShell" | Remove-Module -Force -ErrorAction Ignore
  $path = Join-Path -Path $PSScriptRoot -ChildPath "..\..\..\AzureDevOpsPowerShell\AzureDevOpsPowerShell.psm1" | Resolve-Path
